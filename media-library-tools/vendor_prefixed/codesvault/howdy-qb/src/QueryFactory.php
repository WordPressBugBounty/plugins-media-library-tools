...
namespace TinySolutions\mlt\Vendor\CodesVault\Howdyqb;

use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Api\SelectInterface;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Alter;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Create;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Delete;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Table;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Insert;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Select;
use TinySolutions\mlt\Vendor\CodesVault\Howdyqb\Statement\Update;
class QueryFactory
{
    protected $db = null;
