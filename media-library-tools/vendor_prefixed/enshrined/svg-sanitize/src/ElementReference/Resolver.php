...
namespace TinySolutions\mlt\Vendor\enshrined\svgSanitize\ElementReference;

use TinySolutions\mlt\Vendor\enshrined\svgSanitize\data\XPath;
use TinySolutions\mlt\Vendor\enshrined\svgSanitize\Exceptions\NestingException;
use TinySolutions\mlt\Vendor\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath
